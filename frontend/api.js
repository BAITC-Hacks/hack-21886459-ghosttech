(() => {
  ...
  window.api = {
    ...
    getBusinessProfile: (profileId, params) => request(`/profiles/businesses/${id(profileId)}${query(params)}`),
    getTeamProfile: (profileId, params) => request(`/profiles/teams/${id(profileId)}${query(params)}`),
    ...
    getTeamProposals: (params) => request(`/proposals${query(params)}`),
